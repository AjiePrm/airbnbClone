<template>
    <div class="container px-[34px]">
        ...
        <div class="flex space-x-4 pb-6" >
            <h2 class="text-xl">Khumjung, Eastern Development Region, Nepal</h2>
        ...
        <div class="flex space-x-2 w-[1120px] h-[416px] pb-12">
            <div class="w-[560px] h-[410px] bg-secondaryGray rounded-l-lg">
                <img class="w-[560px] h-[410px] bg-secondaryGray rounded-l-lg" src="" alt="img"/>
            </div>
        ...
        <div>
                <div class="font-semibold text-3xl pb-[6px]">
                    Kamar di penginapan alam. Tuan rumah: Jimmi
                </div>

                <div class="flex space-x-1 text-2xl border-b-2 pb-[26px]">
                    <h2 class="text-2xl"> 16 +tamu  · </h2>
                    <h2 class="text-2xl"> 27 kamar tidur  · </h2>
                    <h2 class="text-2xl"> 50 tempat tidur </h2>
                </div>

                <div class="w-[653px] h-[261px] pt-4">
                    <p class="w-full">aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</p>
                </div>
            </div>
            ...
            <div class="ml-[93px] w-[372px] h-[276px] shadow-2xl rounded-lg">
                <div class="h-[56px] px-[25px] py-[26px]">
                    ...
                    <h1 class="text-2xl font-semibold">$800.000 <span class="text-lg font-normal">/ malam</span></h1>
