<template>
    <div class="container">
        ...
        <div class="relative w-full px-0 flex lg:shadow-2xl lg:rounded-md bg-secondaryWhite">
            <div v-if="isShow !== false" class="absolute top-[-140px] bg-secondaryWhite grid grid-cols-1 
                w-[200px] h-[250px] lg:pl-8 lg:place-content-center md:w-[840px] 
                lg:w-full overflow-y-auto lg:h-[300px] lg:overflow-y-hidden lg:grid-cols-5 
                xl:grid-cols-6 md:grid-cols-3 gap-2 py-3 rounded-xl">
