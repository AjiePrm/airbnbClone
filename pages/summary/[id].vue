  ...
  <div class="container mx-auto px-4 py-8 md:py-20">
    <div class="m-0">
      <div class="basket-module flex flex-col md:w-[200px] md:mx-auto space-y-3 pb-4">
        ...
        />
        <button
          class="promo-code-cta bg-primaryRed text-secondaryWhite rounded-lg px-4 py-2"
      ...
      <div
        class="basket-product lg:w-[1024px] lg:mx-auto flex flex-col md:flex-row"
      ...
      >
        <div class="item w-full md:w-[43%] md:flex mt-4">
          <div class="product-image">
            <img
              :src="product.image"
              :alt="product.name"
              class="product-frame object-cover"
            />
          </div>
        ...
        <div class="remove w-1/5">
          <button
            class="text-primaryGreeb underline"
    ...
    <div class="summary w-full md:w-[500px] lg:w-[1024px] md:mx-auto py-10">
      ...
      <div class="summary-checkout py-2">
        <button
          class="checkout-cta bg-primaryRed text-secondaryWhite rounded-lg w-full py-2"
          @click="checkout"
        >
          Checkout
        </button>
...
export default {
  ...
  if (savedProducts) {
    ...
    checkout() {
      // Implement the logic for handling the checkout
    },
